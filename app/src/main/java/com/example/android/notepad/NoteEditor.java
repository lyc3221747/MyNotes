...
public class NoteEditor extends IatBasicActivity  {
    ...
    private LinearLayout Listen_write;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //听写按钮
        Listen_write = (LinearLayout) findViewById(R.id.listen_write);
        //语音听写
        initIatData(mText);
        Listen_write.setOnClickListener(new View.OnClickListener() {
            @Override
