...
public class NotesList extends ListActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getWindow().getDecorView().setBackgroundResource(R.color.EditorBackground);
        View layoutView = getLayoutInflater().inflate(R.layout.layout_search, null);
        final EditText et_title = (EditText) layoutView.findViewById(R.id.title);
        TextView btn_search = (TextView) layoutView.findViewById(R.id.search);
